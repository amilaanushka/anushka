...
// configure
$from = 'admin@anushkamahalekamge.dev'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'contact@anushkamahalekamge.dev'; // Replace it with Your email. REQUIRED!
$subject = 'New Inquiry for Anushka Mahalekamge';
