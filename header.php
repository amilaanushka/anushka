...
})(window,document,'script','dataLayer','GTM-P78QVNW');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P78QVNW"
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="page-scroll">
    <div id="page_container" class="page-container bg-move-effect" data-animation="">
      ...
      <header id="site_header" class="header">
        <div class="header-content clearfix">
          ...
          <div class="text-logo">
            <a href=".">
              <div class="logo-symbol"><img src="img/logo_s.png" alt="AM" ></div>
              <div class="logo-text">Anushka <span>Mahalekamge</span></div> 
            </a>
          </div>
          <!-- /Text Logo -->
