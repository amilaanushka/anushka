                    ...
                    <div class="row flex-v-align">
                      ...
                      <div class="col-sm-12 col-md-5 col-lg-5">
                        <div class="home-photo">
                          <div class="hp-inner" style="background-image: url(./img/Anushka.jpg);">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-12 col-md-7 col-lg-7">
                        <div class="home-text hp-left">
                          ...
                          <div class="home-buttons">
                            <a href="resume/Anushka_resume.pdf" target="_blank" class="btn btn-primary">Download Resume</a>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="info-list-w-icon">
                    ...
                    <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-note"></i>
                      </div>
                ...
                <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="info-block-w-icon">
                    ...
                    <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-search"></i>
                      </div>
                ...
                <div class="col-xs-12 col-sm-6">
                  ...
                  <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-tag"></i>
                      </div>
                    ...
                    <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-eye"></i>
                      </div>
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="info-list-w-icon">
                    ...
                    <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-cloud"></i>
                      </div>
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="info-list-w-icon">
                    ...
                    <div class="info-block-w-icon">
                      <div class="ci-icon">
                        <i class="linecons linecons-lab"></i>
                      </div>
